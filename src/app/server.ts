...
import volunteerRoutes from './routes/volunteer.routes'; // Import volunteer routes
import blogRoutes from './routes/blog.routes'; // Import blog routes
import eventRoutes from './routes/event.routes'; // Import event routes
...
const swaggerOptions = {
  swaggerDefinition: {
    openapi: '3.0.0',
    info: {
      title: 'API de gestion de la Croix-Rouge',
      version: '1.0.0',
